...
-- 예제1) 현재 직원의 이름과 직책을 출력하되 여성 엔지니어만 출력하세요.
...
-- 실습문제 1: 현재 회사 생활을 반영한 직원별 근무부서를 사번, 직원 전체 이름, 근무부서 형태로 출력하세요.
...
-- 실습문제 2: 
-- 현재 회사에서 지급되고 있는 급여체계를 반영한 결과를 출력하세요. 사번 전체이름 연봉 출력
